 ...
 */
class ProxiBlue_ReCaptcha_Model_Observer extends Mage_Captcha_Model_Observer {
	...
	public function checkUserLogin($observer) {
		...
		if ($captchaModel->isRequired($login)) {
			if (!$captchaModel instanceof ProxiBlue_ReCaptcha_Model_Recaptcha) {
				parent::checkUserLogin($observer);
			} else {
				if (!$captchaModel->isCorrect($observer->getControllerAction()->getRequest())) {
